...
class RefAcademie {
     ...
     * Add departements
     *
     * @param RefDepartement $departements
     * @return RefAcademie
     */
    public function addDepartement(RefDepartement $departements)
    {
        $this->departements[] = $departements;
     ...
     * @param RefDepartement $departements
     */
    public function removeDepartement(RefDepartement $departements)
    {
