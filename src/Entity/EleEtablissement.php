...
class EleEtablissement {
    ...
    public function __construct(){
        ...
        $this->resultatsDetailles = new ArrayCollection();
     ...
     */
    public function setCampagne(EleCampagne $campagne){
     ...
     */
    public function setEtablissement(RefEtablissement $etablissement){
     ...
     * Add resultatDetail
     *
     * @param EleResultatDetail $resultat
     */
    public function addResultatDetail(EleResultatDetail $resultat){
    ...
    /**
     *
     * @param EleFichier $fichier
     */
    public function setFichier(EleFichier $fichier = null){
