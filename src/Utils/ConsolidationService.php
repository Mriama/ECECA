...
class ConsolidationService
{
    ...
    public function consolidationEleEtab($eleEtab, $doFlush = true) {
        ...
        if (null == $typePrioritaire) {
            $typePrioritaire = $this->em->getRepository(RefTypePrioritaire::class)->findOneBy(array(
        ...
        $eleConsolidation = $this->em->getRepository(EleConsolidation::class)->findOneBy(array(
        ...
        if (null == $eleConsolidation) {
            ...
            $nbEtabTotal = $this->em->getRepository(RefEtablissement::class)->getNbEtabParTypeEtablissementZoneTypeElection(null, $zone, $campagne->getTypeElection());
            //correction du nb_total_etab qui prend pas en compte 
            //$nbEtabTotal = $this->em->getRepository(RefEtablissement::class)->getNbEtabParTypeEtablissementZoneTypeElection($typeEtablissement, $zone, $campagne->getTypeElection());
            ...
            $participation = $this->em->getRepository(EleParticipation::class)->find($eleConsolidation->getParticipation()->getId());
            ...
            $elePrioritaire = $this->em->getRepository(ElePrioritaire::class)->findOneBy(array(
        ...
        $liste_resultats = $this->em->getRepository(EleResultat::class)->findBy(array('consolidation' => $eleConsolidation->getId()));
    ...
    public function deconsolidationEleEtab($eleEtab, $campagne)
    {
        ...
        if($eleConsolidation != null) {
            ...
            // Recherche de la consolidation précédente
            $liste_resultats = $this->em->getRepository(EleResultat::class)->findBy(array(
