...
class ClearTrustSoapClient extends \SOAPClient
{
    private $wsdl_uri;
    ...
    public function getEtablissementsDeleg(getEtablissementsDeleg $parameters) {
        return $this->__soapCall ( 'getEtablissementsDeleg', array (
            $parameters
        ), array (
            'uri' => $this->wsdl_uri,
            'soapaction' => ''
    ...
    public function getEtablissementsResp(getEtablissementsResp $parameters) {
        return $this->__soapCall ( 'getEtablissementsResp', array (
            $parameters
        ), array (
            'uri' => $this->wsdl_uri,
            'soapaction' => ''
    ...
    public function getEtablissementsGest(getEtablissementsGest $parameters) {
        return $this->__soapCall ( 'getEtablissementsGest', array (
            $parameters
        ), array (
            'uri' => $this->wsdl_uri,
            'soapaction' => ''
    ...
    public function getUtilisateur(getUtilisateur $parameters) {
        return $this->__soapCall ( 'getUtilisateur', array (
            $parameters
        ), array (
            'uri' => $this->wsdl_uri,
            'soapaction' => ''
    ...
    public function getProxy(getProxy $parameters) {
        return $this->__soapCall ( 'getProxy', array (
            $parameters
        ), array (
            'uri' => $this->wsdl_uri,
            'soapaction' => ''
